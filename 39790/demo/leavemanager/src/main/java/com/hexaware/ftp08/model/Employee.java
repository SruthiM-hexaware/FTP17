...
public class Employee {
   ...
   * @param argEmpEmail to initialize employee email.
   * @param argEmpMobNo to initialize employee mobile number.
   * @param argEmpDateJoined to initialize employee date.
   */
  public Employee(final int argEmpId, final String argEmpName, final String argEmpEmail, final long argEmpMobNo,
                  final String argEmpDateJoined) {
    this.empId = argEmpId;
    this.empName = argEmpName;
    this.empEmail = argEmpEmail;
    this.empMobNo = argEmpMobNo;
  ...
  public static int enterData() {
    return dao().insert(1, "s", "EMAIL", 54544, "ff");
  }
