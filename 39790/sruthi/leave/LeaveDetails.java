...
public class LeaveDetails {
  ...
  */
  public LeaveDetails(final int noofdays, final Date sd, final Date ed, final String lr, final int empid) {
  ...
  */
   ...
   * @return to return the leave details.
   */
  public static LeaveDAO d() {
